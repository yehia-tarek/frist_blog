...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="navbar navbar-expand-md navbar-dark bg-dark mb-4" role="navigation">
            <a class="navbar-brand" href="{{route('home.index')}}">NEWSPAPER</a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link disabled" href="{{route('home.logout')}}">logout</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown1">
                            <a href="{{route('categories.index')}}"><li class="dropdown-item">show categories</li></a>
                            <a  href="{{route('categories.create')}}"><li class="dropdown-item">create category</li></a>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="dropdown2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">NEWS</a>
                        <ul class="dropdown-menu" aria-labelledby="dropdown2">
                            <a href="{{route('news.index')}}"><li class="dropdown-item">show News</li></a>
                            <a  href="{{route('news.create')}}"><li class="dropdown-item">create News</li></a>
